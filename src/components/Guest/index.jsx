...
export default function Guest() {
  ...
  const guests = [
    { 
      ...
      description1: <span>Artificial Intelligence will be the defining technology of the 21st century. What can it do for our businesses and communities? And how will it help us emerge stronger from this pandemic?</span>,
      description2: <span>The podcast is presented by <mark className={classes.name}>Matt Brittin</mark>, President of Google’s Business Operations in EMEA, and <mark className={classes.name}>Dara Ó Briain</mark>, a well-known broadcaster, comedian and science presenter in the UK and Ireland. They are joined by <mark className={classes.name}>Demis Hassabis</mark>, founder and CEO of Google’s sister company DeepMind, and a world leader in the field of AI.</span>,
